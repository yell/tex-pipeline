...
% # Document structure
\usepackage[acronym,symbols,nomain,nogroupskip,nonumberlist,nopostdot,toc,sort=def]{glossaries}
...
% \usepackage{pgf,pgfplots}  % uses PGF to draw professionally looking charts and plots
